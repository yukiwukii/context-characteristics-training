...
python src/property_detection/get_properties.py --data_path "data/tulu/chunks/chunk_an.csv" --save_folder "data/tulu/results/chunk_an" --properties "flesch_reading_ease_score uncertain_rate_lexicon claim_evidence_jaccard_sim evidence_length claim_length"
